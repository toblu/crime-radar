...
function signup({ email, password, req }: {email: string, password: string, req: AuthContext}) {
...
function login({ email, password, req }: {email: string, password: string, req: AuthContext }) {
  return new Promise((resolve, reject) => {
